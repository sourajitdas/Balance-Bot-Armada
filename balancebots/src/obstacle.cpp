...
ros::init(argc, argv, "botguider");
ros::NodeHandle n;

//ROS_INFO("before subscribe");
ros::Subscriber sub = n.subscribe("vicon/bbot_m/pose", 100, bot_m_loc);
ros::Subscriber sub1 = n.subscribe("vicon/bbot_1/pose", 100, bot1location);
//ROS_INFO("after subscribe");

ros::Rate loop_rate(100);

ros::ServiceClient client = n.serviceClient<balancebots::instruction>("bot1follower");
...
ROS_INFO("phi=%f gamma=%f",srv.request.phi,srv.request.gamma);
usleep(2000000);
